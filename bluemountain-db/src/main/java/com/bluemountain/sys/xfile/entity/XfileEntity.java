...
package com.bluemountain.sys.xfile.entity;
...
public class XfileEntity extends EntitySupport {
	...
	public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("com.xjj.wefactory.sys.xfile.entity.XfileEntity").append("ID="+this.getId()).toString();
    }
}
