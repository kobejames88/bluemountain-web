 ...
 * be used when the data is already parsed, for so206 from a grid view component.
...
(function (Highcharts) {	
	...
	/**
	 * Get the column distribution. For so206, a line series takes a single column for
