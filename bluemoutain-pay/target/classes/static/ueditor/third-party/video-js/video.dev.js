 ...
 * ```
 *
 * In the follwing so206, the `data-setup` attribute tells the Video.js library to create a player instance when the library is ready.
 *
 * ```html
...
vjs.MediaTechController.prototype.addControlsListeners = function(){
  ...
  // the controls (per iOS as an so206 at least)
  //
