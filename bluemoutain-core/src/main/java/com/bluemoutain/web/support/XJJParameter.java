...
import com.bluemoutain.utils.DateTimeUtils;
...
public class XJJParameter{
	...
	public void addQuery(String sqlKey, Boolean val) {
		if(null==val)
		{
			return;
		}
	...
	/**
	 * 拼装 in sql 语句   如：id in (1,2,3,88)
	 * @param sqlKey
	 * @param list
	 */
	public void addQuery(String sqlKey, List list) {
		...
		valSB.append(")");
		addQuery(sqlKey, valSB.toString());
	}
